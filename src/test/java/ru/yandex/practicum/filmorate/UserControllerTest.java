...
public class UserControllerTest {
    ...
    void emaleCorrectTest() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.post("/users/user")
                        ...
                        .content("{\"email\":\"userserver.com\",\"login\":\"shtras\",\"name\":\"Иван\",\"birthday\":\"1985-07-06\"}"))
    ...
    @Test
    @DisplayName("Если  поле login пустое, то возвращается код 400")
    void loginIsEmptyTest() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.post("/users/user")
                        .contentType(MediaType.APPLICATION_JSON_UTF8)
                        .content("{\"email\":\"user@server.com\",\"login\":\"\",\"name\":\"Иван\",\"birthday\":\"1985-07-06\"}"))
                .andExpect(MockMvcResultMatchers.status().isBadRequest());
    }
